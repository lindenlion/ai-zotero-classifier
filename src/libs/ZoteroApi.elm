...
noteDecoder =
    Decode.map4 ZoteroNote
        (Decode.field "key" Decode.string)
        (Decode.field "version" Decode.int)
        (Decode.at [ "data", "note" ] Decode.string)
        (Decode.at [ "data", "tags" ] (Decode.list tagDecoder)
            |> Decode.maybe
            |> Decode.map (Maybe.withDefault [])
        )
...
{-| Detect auto-generated notes by content markers or tag.
-}
...
isReasoningNote note =
    String.contains "Inclusion reasoning" note.note
        ...
        || List.any (\t -> t.tag == "auto-generated") note.tags


autoGeneratedTag : Encode.Value
autoGeneratedTag =
    Encode.list identity
        [ Encode.object [ ( "tag", Encode.string "auto-generated" ) ] ]
